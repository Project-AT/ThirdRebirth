...
var items as string[] = [
    "mana_petals", "straw_rope", "rune", "rune1", "end_portal_frame_debris", "insulating_substrate","blast_furnace_fuel", 
    ...
    "compressed_draconium", "compressed_signalum", "refractory_brick", "refractory_clay_ball", "rusty_iron_ingot", "tough_alloy_plate"
];
