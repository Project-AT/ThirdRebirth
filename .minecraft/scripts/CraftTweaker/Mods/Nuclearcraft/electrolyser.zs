...
function addRecipe(input as ILiquidStack, output1 as ILiquidStack, output2 as ILiquidStack = null, output3 as ILiquidStack = null, output4 as ILiquidStack = null) {
...
Electrolyzer.addRecipe(<liquid:heavy_water> * 500, <liquid:liquiddeuterium> * 500, <liquid:liquidoxygen> * 250, null, null);