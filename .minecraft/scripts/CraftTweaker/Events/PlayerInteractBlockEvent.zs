...
events.onPlayerInteractBlock(function(event as PlayerInteractBlockEvent){
    ...
    if(!event.world.remote && !isNull(currentItem)){
        if(currentItem.hasTag && common.getItemID(currentItem) has "minecraft:flint_and_steel" && !player.creative){
        ...
        if(common.getItemID(currentItem) has "minecraft:ender_eye" && !player.creative){
        ...
        if(common.getItemID(currentItem) has "minecraft:ender_eye"){
